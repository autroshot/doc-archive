...
<Image
  img={require('/img/docs/prisma/pagination/offset-skip-take.png')}
  alt="오프셋의 skip과 take"
/>
...
<Image img={require('/img/docs/prisma/pagination/cursor-1.png')} alt="커서 1" />
...
<Image img={require('/img/docs/prisma/pagination/cursor-2.png')} alt="커서 2" />
...
<Image img={require('/img/docs/prisma/pagination/cursor-3.png')} alt="커서 3" />
