...
<IdealImage img={compiling} alt={'컴파일'} />
...
<IdealImage img={minifying} alt={'축소'} />
...
<IdealImage img={bundling} alt={'번들링'} />
...
<IdealImage img={codeSplitting} alt={'코드 분할'} />
...
<IdealImage img={clientServer} alt={'클라이언트와 서버'} />
...
<IdealImage img={preRendering} alt={'사전 렌더링'} />
