...
넥스트의 장점은 SSG, SSR, SCR에 관계없이 페이지별로 유스 케이스에 가장 적합한 렌더링 방법을 선택할 수 있다는 것입니다. 특정 유스 케이스에 적합한 렌더링 방법에 대한 자세한 내용은 [데이터 가져오기](../basic-features/data-fetching/index.md)에서 확인하세요.
