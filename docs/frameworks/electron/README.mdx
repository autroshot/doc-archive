...
import menu from '/img/docs/electron/introduction/menu.png';
import autoUpdater from '/img/docs/electron/introduction/auto-updater.png';
import installer from '/img/docs/electron/introduction/installer.png';
import appStore from '/img/docs/electron/introduction/app-store.png';
import crashReporting from '/img/docs/electron/introduction/crash-reporting.png';
import fiddle from '/img/docs/electron/introduction/fiddle.png';
...
<Image img={fiddle} alt="일렉트론 피들의 기본 창의 스크린숏" maxWidth="500px" />
