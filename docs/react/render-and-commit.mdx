...
컴포넌트를 부엌에서 재료로 맛있는 요리를 조립하는 요리사라고 상상해 보세요. 이 시나리오에서 리액트는 고객의 요청을 접수하고 주문을 가져오는 웨이터입니다. UI를 요청하고 제공하는 이 프로세스에는 다음의 세 단계가 있습니다.
...
<iframe
  src="https://codesandbox.io/embed/gallant-waterfall-mnfdp5?codemirror=1&fontsize=14&hidenavigation=1&view=editor"
  style={{
    width: '100%',
    height: '500px',
    border: '0',
...
<iframe
  src="https://codesandbox.io/embed/practical-mccarthy-1p08zd?codemirror=1&module=%2FGallery.js&fontsize=14&hidenavigation=1&view=editor"
  style={{
    width: '100%',
    height: '500px',
    border: '0',
...
<iframe
  src="https://codesandbox.io/embed/modern-snowflake-y5b4hi?codemirror=1&module=%2FClock.js&fontsize=14&hidenavigation=1&view=editor"
  style={{
    width: '100%',
    height: '500px',
    border: '0',
