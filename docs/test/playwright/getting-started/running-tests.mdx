...
import img1 from '/img/docs/playwright/debugging-tests-with-the-playwright-inspector.png';
import img2 from '/img/docs/playwright/html-reporter-test-reports-view.png';
import img3 from '/img/docs/playwright/html-reporter-test-reports-detailed-view.png';
...
<Image img={img1} alt={'플레이라이트 검사기로 테스트 디버깅'} />
