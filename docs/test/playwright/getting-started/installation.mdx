...
npm 또는 얀으로 플레이라이트를 설치하여 시작하세요. 또는 [VS 코드 확장](docs/test/playwright/getting-started/vs-code.mdx)을 사용하여 테스트를 시작하고 실행할 수도 있습니다.
...
헤드 모드에서 테스트 실행, 여러 테스트 실행, 특정 테스트 실행 등에 대한 자세한 내용은 [테스트 실행](docs/test/playwright/getting-started/running-tests.mdx) 문서를 참고하세요.
...
<IdealImage img={htmlReporter} alt={'HTML 보고서'} />
