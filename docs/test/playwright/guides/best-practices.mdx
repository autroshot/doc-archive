...
<IdealImage
  img={generatingLocatorsWithCodegen}
  alt={'코드젠으로 탐지기 생성하기'}
/>
...
<IdealImage img={debuggingTestsInVSCode} alt={'VS 코드의 테스트 디버깅'} />
...
<IdealImage img={debuggingWithTheInspector} alt={'검사기로 디버깅하기'} />
...
<IdealImage img={openTraceInReport} alt={'보고서에서 추적 열기'} />
